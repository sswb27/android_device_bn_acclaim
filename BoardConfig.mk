...
# wlan build
WLAN_MODULES:
	make clean -C device/bn/acclaim/wlan/compat_wl12xx
	make -j8 -C device/bn/acclaim/wlan/compat_wl12xx KERNEL_DIR=$(KERNEL_OUT) KLIB=$(KERNEL_OUT) KLIB_BUILD=$(KERNEL_OUT) ARCH=arm CROSS_COMPILE="arm-eabi-"
